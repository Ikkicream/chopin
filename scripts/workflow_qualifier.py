...
def qualify_prospect(prospect: dict, site: str = "lcr") -> dict:
    ...
    # RGPD : on N'ENVOIE PAS les données personnelles directes (email, téléphone) au LLM,
    # car DeepSeek est hors UE (Chine). Company/secteur/ville/site suffisent à qualifier.
    facts = {
